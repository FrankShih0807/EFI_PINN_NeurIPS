...
class EFI_Net(nn.Module):
    def __init__(self, 
        ...
        self.encoder = EncoderNetwork(input_dim=self.encoder_input_dim, output_dim=self.n_parameters, activation_fn=activation_fn)
...
if __name__ == "__main__":
    ...
    net = EFI_Net(input_dim=1, output_dim=1, hidden_layers=[15, 15, 15])
    ...
    xx = torch.randn(10) * 0.1
    xx_loss = net.sparsity_loss(xx)
    print(xx_loss)
    
    print(net.gmm_prior_loss())